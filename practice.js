...
function evenFinder(nums){
  var arr = nums.filter(function(elem){
    if(elem % 2 === 0){
      return elem;
    }
  })
...
function divider(numbersArray) {
  var evensArray = numbersArray.filter(function(elem) {
    if(elem % 2 === 0) {
      return elem;
    }
  })
  var oddsArray = numbersArray.filter(function(elem) {
    if(elem % 2 === 1) {
      return elem;
    }
  })
...
users.push({
  name: "Jeremy Coplen",
  email: "jeremycoplen99@gmail.com",
  password: "Yeet",
  username: "Jcop"
})
...
users.push({
  name: "Jake Rowland",
  email: "jakerowland99@gmail.com",
  password: "Yikes",
  username: "PC Master Race"
})

users.push({
  name: "Kaleb Manley",
  email: "kalebmanely99@gmail.com",
  password: "swag",
  username: "I Love Fortnite"
})
